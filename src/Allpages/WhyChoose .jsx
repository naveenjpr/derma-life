      ...
      <section className="w-[100%] mt-[100px]">
        ...
        <div className="max-w-[1170px] mx-auto">
          <p className="text-[17px] leading-[30px] text-[grey] text-center">
            “ Our hair transplant surgeon has in-depth knowledge in
            understanding your intricate problems and has adept skills in
            performing the procedure in a highly proficient manner. Also, the
            uniqueness of our hair transplantation is that it implements
            innovative techniques such as”
          </p>
          <div className=" grid grid-cols-2 gap-[5px] font-normal	">
        ...
        <div className="max-w-[1170px] mx-auto mt-[50px]">
          ...
          <div className="grid grid-cols-2 gap-[15px]">
            <div>
              <h1 className="text-[24px] leading-[35px] font-[500] px-[11px]">
                C 15 , Ground Floor Green Park Market Road, Green Park
                Extension, New Delhi, Delhi 110016
              </h1>
              <ul className="text-[#666]">
                <li className="py-[10px]">
                  <span className="pe-[15px] font-[500]">Email:</span> info@dermalife.co.in
                </li>
                <li className="py-[10px]">
                  <span className="pe-[15px] font-[500] ">Phone:</span>+91-7230019135
                </li>
